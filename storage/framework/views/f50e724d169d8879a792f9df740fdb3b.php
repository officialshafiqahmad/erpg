                                    ...
                                    <li
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage biometric attendance')): ?>
                                                <li class="dash-item">
                                                    <a class="dash-link" href="<?php echo e(route('biometric-attendance.index')); ?>"><?php echo e(__('Biometric Attendance')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                    </li>
...
<?php /**PATH /home/plan8376/public_html/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>
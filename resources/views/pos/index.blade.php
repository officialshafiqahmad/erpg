...
<body class="{{ $themeColor }}">
            ...
            <div class="col-lg-5 ps-lg-0">
                <div class="card m-0">
                    <div class="card-header p-2">
                        <div class="row">
                            <div class="col-md-6">
                                {{ Form::select('customer_id', $customers, $customer, ['class' => 'form-control select customer_select', 'id' => 'customer', 'required' => 'required']) }}
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#warehouse').change(function() {
                var ware_id = $("#warehouse").val();
                searchProductsSku(url, '', '0', ware_id);
            });
            ...
            $(document).on('keyup', 'input#searchproductsku', function() {
                ...
                if (value != '') {
                var cat = $('.cat-active').children().data('cat-id');
                searchProductsSku(url, value, cat);
                }
            });
            ...
            function searchProductsSku(url, value, cat_id, cash_register_id = '0') {
                $('#product-listing').html('');
                $.ajax({
                    type: 'GET',
                    url: url,
            ...
            $(function() {
                getProductCategories();
                var url = '{{ route('search.products.sku') }}'
                searchProductsSku(url, '', '');
